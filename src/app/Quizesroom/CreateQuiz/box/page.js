            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {quizOptions.map((proj, index) => (
                    <div
                        ...
                        className="flex flex-col items-center justify-center p-8 rounded-xl text-center cursor-pointer transition-all duration-300 hover:scale-95 hover:shadow-lg"
                        style={{
                            background: "#1e1e29",
                        ...
                        role="button"
                        tabIndex={0}
                        aria-label={`Select ${proj.title} option`}
                        onKeyDown={(e) => {
                            if (e.key === 'Enter' || e.key === ' ') {
                                handleCardClick(proj.link);
                            }
                        }}
                    >
                        {/* Document icon */}
                        ...
                        <p className="text-xs text-gray-500">
                            {Array.isArray(proj.details) ? proj.details.join(", ") : proj.details}
                        </p>
                    </div> 
                ))}
            </div>
...
const quizOptions = [
    {
        ...
        link: "/Quizesroom/CreateQuiz/document_upload"
    },
    {
        title: "Paste Text",
        ...
        icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
        link: "/Quizesroom/CreateQuiz/text_input"
    },
    {
        title: "Choose Topic",
        ...
        link: "/Quizesroom/CreateQuiz/topic_selection"
    },
    {
        title: "Upload Image",
        ...
        link: "/Quizesroom/CreateQuiz/image_upload"
    },
    {
        title: "Custom Quiz",
        ...
        link: "/Quizesroom/CreateQuiz/question_creation_interface"
    }
];